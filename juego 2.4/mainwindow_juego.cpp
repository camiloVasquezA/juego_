...
music->stop();
    ...
    if(mArkanoid->getscena2()->nbloq==0 && mArkanoid->getscena2()->puntaje==400){
       music->stop();
        QMessageBox::information(this,"Arkanoid","Fin del juego");
        mArkanoid->getscena2()->setvidas(3);
        t= mArkanoid->getscena()->puntaje;
    ...
    if(mArkanoid->getscena3()->getvidas()==0){
       music->stop();
        ...
        niveles *n=new niveles(nom1,0);
        n->show();
        this->close();

    }

    if(mArkanoid->getscena3()->getvidas()==0 && mArkanoid->getscena3()->puntaje==41){
       music->stop();
        QMessageBox::information(this,"Arkanoid","Fin del juego");
        mArkanoid->getscena3()->setvidas(3);
    ...
    if(mArkanoid->getscena4()->getvidas()==0&& mArkanoid->getscena3()->puntaje==34){
        music->stop();
        QMessageBox::information(this,"Arkanoid","Fin del juego");
        mArkanoid->getscena4()->setvidas(3);
